...
zooAnimals.forEach(function(item) {
  displayNames.push(`names: ${item.animal_name}, scientific: ${item.scientific_name}`)
});
...
let lowerCaseAnimalNames = zooAnimals.map(function(zooAnimal)  {
...
let lowPopulation = zooAnimals.filter(function(zooAnimal) {
...
*/
let populationTotal = zooAnimals.reduce((population, zooAnimal) => {
